ggRFVignette: Documentation for the ggRandomForests package
========================================================
The [ggRFVignettes](http://github.com/ehrlinger/ggRFVignettes) package contains vignettes for the [ggRandomForests](http://CRAN.R-project.org/package=ggRandomForests) which could not be distributed with the package due to CRAN size limits. You can install these vignettes using the [devtools](http://CRAN.R-project.org/package=devtools) package from github directly using `devtools::install_github("ehrlinger/ggRFVignettes")`.
