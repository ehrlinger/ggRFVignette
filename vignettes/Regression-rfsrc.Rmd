...
title:
  formatted: "\\pkg{ggRandomForests}: Regression \\pkg{randomForestSRC}"
  # If you use tex in the formatted title, also supply version without
  plain:     "ggRandomForests: Regression randomForestSRC"
  # For running headers, if needed
  short:     "\\pkg{ggRandomForests}: Regression \\pkg{randomForestSRC}"
preamble: |
  \usepackage{natbib}
  \usepackage{booktabs}
...
keywords:
  ...
  formatted: [random forest, regression, VIMP, minimal depth, "\\proglang{R}", "\\pkg{randomForest}", "\\pkg{randomForestSRC}", "\\pkg{ggRandomForests}"]
  plain:     [random forest, regression, VIMP, minimal depth, R, randomForest, randomForestSRC, ggRandomForests]
output:  
  rticles::jss_article:
