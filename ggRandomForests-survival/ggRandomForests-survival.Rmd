...
```{r timeSurface3d, fig.cap="Partial dependence surface. Partial dependence of predicted survival (0 to 5 years) as a function of bili. Blue lines indicate partial dependence at 1 and 3 years, as in bili panel of \\autoref{fig:pbc-partial-panel}.", fig.width=7, fig.height=5}
...
```{r surface3d, fig.cap="Partial dependence surface of survival at 1 year as a funtion of bili and albumin. Blue lines indicate partial coplot cut points for albumin (\\autoref{fig:bili-albumin}) and bili (\\autoref{fig:albumin-bili}).", fig.width=7, fig.height=5}
